    ...
    return (
        <>
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 flex flex-col items-center p-6">
                ...
                >
                    <button className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow hover:shadow-md">
                        ...
                        <Link to = '/parts/prt3' className="text-indigo-700 font-semibold">Home</Link>
                    </button>
            ...
            <div className="flex justify-between items-center mt-4 p-4 bg-gray-100 rounded-lg shadow-md">
                ...
                <button
                    onClick={() => navigate('/part3/chapters/ch12')}
...
function Zone({ title, refEl, children, glow, hint, bg, icon }) {
    return (
        ...
        >
            ...
            <div
                className={`absolute inset-0 pointer-events-none rounded-2xl transition shadow-[0_0_0_3px_rgba(99,102,241,0)] ${glow ? "ring-4 ring-indigo-300/60" : ""
                    }`}
            />
