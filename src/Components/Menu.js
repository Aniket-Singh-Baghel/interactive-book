                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-baseline space-x-4">
                            <Link to="/station" className="flex items-center px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700">
                             ...
                             <div className="relative group">
                                ...
                                <ul className="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-20 hidden group-hover:block text-gray-800">
                     ...
                     <div className="hidden md:flex items-center">
                        <button onClick={() => setLanguage('en')} className={`px-3 py-1 rounded-lg border border-white text-sm font-semibold ${language === 'en' ? 'bg-white text-blue-600' : 'bg-transparent'}`}>EN</button>
                        <button onClick={() => setLanguage('hi')} className={`ml-2 px-3 py-1 rounded-lg border border-white text-sm font-semibold ${language === 'hi' ? 'bg-white text-blue-600' : 'bg-transparent'}`}>हिं</button>
                    </div>
                    <div className="-mr-2 flex md:hidden">
                        <button onClick={() => setIsOpen(!isOpen)} className="bg-indigo-600 inline-flex items-center justify-center p-2 rounded-md text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white">
