                ...
                <div className="w-full max-w-5xl flex justify-between items-center mb-6 px-4">
                    ...
                    <div className="flex space-x-2">
                        <button
                            ...
                            className={`px-3 py-1 text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${
                        ...
                        <button
                            ...
                            className={`px-3 py-1 text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 ${
                                language === 'hi' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700'
                            }`}
                        >
                            HI
                        </button>
