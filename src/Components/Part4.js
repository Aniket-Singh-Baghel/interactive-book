...
const content = {
  en: {
    ...
    modules: {
      1: { title: "First Steps into the Digital World", emoji: "🚀" },
      2: { title: "Your Life Online", emoji: "🌐" },
      3: { title: "The Brain of the Internet", emoji: "🧠" },
      4: { title: "The New Technological Frontier", emoji: "🌌" },
      5: { title: "Our Digital Future & Responsibility", emoji: "🤝" },
      6: { title: "Your Practical Digital Toolkit", emoji: "🛠️" },
    },
    chapters: [
      // Module 1
      {
  ...
  hi: {
    ...
    modules: {
      1: { title: "डिजिटल दुनिया में पहला कदम", emoji: "🚀" },
      2: { title: "आपका ऑनलाइन जीवन", emoji: "🌐" },
      3: { title: "इंटरनेट का मस्तिष्क", emoji: "🧠" },
      4: { title: "नई तकनीकी सीमा", emoji: "🌌" },
      5: { title: "हमारा डिजिटल भविष्य और जिम्मेदारी", emoji: "🤝" },
      6: { title: "आपकी प्रैक्टिकल डिजिटल टूलकिट", emoji: "🛠️" },
    },
    chapters: [
      // Module 1
      {
