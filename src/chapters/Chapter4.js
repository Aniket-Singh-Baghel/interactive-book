  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-100 p-6 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl">
        ...
        >
          <img src="https://ict-book.netlify.app/static/media/ramStorage.1f1a954db093f457b35e.png" alt="RAM Cartoon" className="mx-auto w-75 h-75 object-contain" />
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.03 }}
        >
          <img src="https://cyberhoot.com/wp-content/uploads/2020/12/1_smpUI4VO-KlX4nTZZCPLEA-1024x579.png" alt="Storage Cartoon" className="mx-auto w-75 h-75 object-contain" />
